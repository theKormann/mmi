...
function ReallContent() {
  ...
  const [priceRange, setPriceRange] = useState("todos"); // ✅ Novo state para faixa de preço
  ...
  const filteredProperties = useMemo(() => {
    return allProperties.filter((property) => {
      ...
      // Nova lógica para faixa de preço
      const matchesPrice = () => {
        ...
        return property.price >= min; // Para casos como "2000000+"
      };
    ...
    if (filteredProperties.length === 0) {
      return (
        <div className="flex flex-col items-center justify-center py-12">
            ...
            <span className="text-slate-500 font-semibold">Nenhum imóvel encontrado.</span>
        </div>
      );
    }
    return (
        ...
        <section>
          <div className="bg-slate-100 p-6 rounded-lg mb-8">
            <div className="flex justify-between items-center mb-4">
                ...
                <Button variant="ghost" onClick={handleClearFilters} className="text-sm text-slate-600 hover:text-slate-900">
                    <X className="mr-2 h-4 w-4" />
                    Limpar Filtros
                </Button>
            </div>

            {/* ✅ Layout do grid de filtros melhorado */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {/* ✅ Novo seletor de faixa de preço */}
              ...
              <Select value={bedrooms} onValueChange={setBedrooms}>
                <SelectTrigger>
                  <BedDouble className="mr-2 h-5 w-5 text-slate-400" />
              ...
              <Select value={bathrooms} onValueChange={setBathrooms}>
                <SelectTrigger>
                  <Bath className="mr-2 h-5 w-5 text-slate-400" />
              ...
              <Select value={garages} onValueChange={setGarages}>
                <SelectTrigger>
                  <Car className="mr-2 h-5 w-5 text-slate-400" />
