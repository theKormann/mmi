      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none">
        <div className="text-center max-w-2xl px-6 pointer-events-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button className="w-full sm:w-auto px-6 py-3 rounded-full border border-[#1F4F91] text-[#1F4F91] hover:bg-[#1F4F91] hover:text-[#FFFFFF] transition-all duration-200">
              Contato
            </button>
          </div>
        </div>
