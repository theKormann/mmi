...
/>
          ...
          <div className="hidden md:flex flex-1 justify-center items-center">
            <div className="hidden lg:flex items-center space-x-8 mr-8">
              ...
              <Link href="/about" className="text-[#4D4D4D] hover:text-[#1F4F91] font-medium transition-colors">
                Sobre Nós
              </Link>
              <Link href="/contact" className="text-[#4D4D4D] hover:text-[#1F4F91] font-medium transition-colors">
                Contato
              </Link>
            </div>
        ...
        >
          <div className="flex flex-col space-y-4">
            ...
            <Link href="/about" className="text-[#4D4D4D] hover:text-[#1F4F91] font-medium py-2 transition-colors" onClick={() => setIsMenuOpen(false)}>
              Sobre Nós
            </Link>
            <Link href="/contact" className="text-[#4D4D4D] hover:text-[#1F4F91] font-medium py-2 transition-colors" onClick={() => setIsMenuOpen(false)}>
              Contato
            </Link>
          </div>
        </div>
