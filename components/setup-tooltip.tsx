...
export function SetupTooltip() {
  ...
  const whatsappNumber = "SEUNUMERO"; // Lembre-se de substituir pelo seu número de telefone
    ...
    <div className="fixed bottom-4 right-4 z-50 w-96 max-w-[calc(100vw-2rem)]">
      <Card className="shadow-2xl border-2 border-black">
        ...
        <CardContent className="space-y-4">
          ...
          <Button 
            asChild 
            className="w-full bg-[#128C7E] text-black hover:bg-[#25D366] flex items-center justify-center transition-colors"
          >
